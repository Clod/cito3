...
class RegisterWidget extends StatefulWidget {
  ...
  @override
  MyRegisterWidget createState() => MyRegisterWidget();
}

class MyRegisterWidget extends State<RegisterWidget>
